...
class TestUnifiedYieldFatigue:
    ...
    def test_materials_database(self):
        """材料データベースの整合性"""
        from delta_theory.unified_yield_fatigue_v6_9 import MATERIALS
    ...
    def test_fatigue_life_below_threshold(self):
        """r ≤ r_th で無限寿命"""
        from delta_theory.unified_yield_fatigue_v6_9 import MATERIALS, calc_sigma_y, fatigue_life_const_amp
...
class TestMaterials:
    ...
    def test_import(self):
        """インポートテスト"""
        from delta_theory.materials import MaterialGPU
